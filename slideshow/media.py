...
def _escape_cifs_option(value: str) -> str:
    ...
    und Dollarzeichen escaped werden, da der Mount-Helfer die Optionsliste an
    ``/bin/mount`` als in Anführungszeichen gesetzten Parameter übergibt und
    ansonsten die Shell-Quote-Balance verloren geht oder eine Parameter-
    Expansion ausgelöst würde.
    """
